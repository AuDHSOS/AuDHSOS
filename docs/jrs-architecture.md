...
| G5 | `instanceof` (13.10.2, `OrdinaryHasInstance` 7.3.22) und die Schreibregel, die heute jeden Namen ablehnt, den eine Prototype besäße, statt nur die ungebauten. | Der Test262-Harness lädt im Engine-Core; ab hier sind Test262-Zahlen für diesen Pfad überhaupt messbar. |
