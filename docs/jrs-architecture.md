...
| G5o | Die Intrinsics, die der Harness zur Laufzeit braucht, allen voran `%Array%` (23.1) mit `Array.isArray` (23.1.2.2). `harness/propertyHelper.js` scheitert daran, und mit ihm 946 Varianten, die heute als fehlgeschlagener Harness zählen. | `harness/propertyHelper.js` läuft im Engine-Core durch. |
