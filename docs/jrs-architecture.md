...
| G6a | Die Konstruktoren, an denen die Varianten jetzt stehen: `%Number%` (21.1), `%Boolean%` (20.3), dazu `%Reflect%` (28.1) und `%Symbol%` (20.4). | Die Varianten, die heute an einem dieser Namen stehen, erreichen ihre Assertions. |
