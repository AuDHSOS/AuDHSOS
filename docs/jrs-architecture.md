...
| G5p | Die übrigen Konstruktoren, die Clause 19 dem globalen Objekt gibt, zuerst `%Object%` (20.1) mit `Object.defineProperty` und `Object.getOwnPropertyDescriptor`. `harness/propertyHelper.js` scheitert daran, und mit ihm 946 Varianten, die heute als fehlgeschlagener Harness zählen. | `harness/propertyHelper.js` läuft im Engine-Core durch. |
