...
| G5k | `arguments` (10.4.4): das Arguments-Object eines Aufrufs. `harness/propertyHelper.js` scheitert daran, und mit ihm 946 Varianten, die heute als fehlgeschlagener Harness zählen. | `harness/propertyHelper.js` läuft im Engine-Core. |
