...
| G5l | `delete` (13.5.1) und `[[Delete]]` eines Ordinary Objects (10.1.10): die Shape ohne den Namen. `harness/propertyHelper.js` scheitert in `isConfigurable` daran, und mit ihm 946 Varianten, die heute als fehlgeschlagener Harness zählen. | `harness/propertyHelper.js` läuft im Engine-Core. |
