...
| 17 | [Text and fonts](17-text-and-fonts.md) | The pure `text-core` track: borrowed font parsing, fixed-point geometry, Unicode, shaping, resolution, and layout; separate future rasterization and drawing integration |
...
to for a CFF outline (D-157), [iso/](iso) for the standard that is its
normative form (D-155), [itu/](itu) for the JPEG Recommendations,
