...
118 191 cases of 846 files: 105 447 pass, 3433 answer differently and
9311 are refused.

What the 9311 refusals are for, most first: `db status` (2106), which
...
|---------------|-------:|---------------------:|--------:|
| `utf8-4096-delete` | 105 447 | 3433 | 9311 |
