...
117 336 cases of 824 files: 104 740 pass, 3299 answer differently and
9297 are refused.

What the 9297 refusals are for, most first: `db status` (2106), which
...
|---------------|-------:|---------------------:|--------:|
| `utf8-4096-delete` | 104 740 | 3299 | 9297 |
