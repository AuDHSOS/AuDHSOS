...
108 095 cases of 798 files: 95 668 pass, 3181 answer differently and
9246 are refused.

What the 9246 refusals are for, most first: `db status` (2106), which
...
|---------------|-------:|---------------------:|--------:|
| `utf8-4096-delete` | 95 668 | 3181 | 9246 |
