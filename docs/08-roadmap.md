...
S1 to S5 are built and S6 to S8 are not (D-123).
...
[document 14](14-secure-shell-as-a-client.md), begun. Steps S1 to S5 are
...
hash, and the authentication exchange with `publickey`. What is left is
the channel layer of S6, the re-exchange of S7, and the integration of
S8, which is what the two open questions of 14.13 belong to.
...
Tests: catalog 6.6.66, 6.6.68, 6.6.69, 6.6.70, 6.6.75 and 6.6.76 are
written, for the arithmetic of S2 and the whole of S1 to S5; the rest are written
