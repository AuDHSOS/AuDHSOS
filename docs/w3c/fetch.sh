...
# CSS Fonts Module Level 4 names by a relative path. Run from anywhere; writes
...
base=https://www.w3.org/TR/2026/WD-css-fonts-4-20260913
grep -oE 'src="[^"]*"' "$dir/css-fonts-4.html" |
	sed 's/src="//;s/"$//;s|^\./||' |
