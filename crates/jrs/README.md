...
| `%TypedArray%` and the twelve of table 71 (focused) | focused | `01288ab` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/TypedArray test/built-ins/TypedArrayConstructors --summary` | 2,184 | 4,322 | 1,590 (36.79%) | 1,224 (28.32%) | 1,508 (34.89%) |
...
| Complete pinned suite, including staging and Intl | full | `01288ab` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 35,574 (34.56%) | 30,711 (29.84%) | 36,640 (35.60%) |
| Complete pinned suite on the register engine | full | `01288ab` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,259 (38.14%) | 19,826 (19.26%) | 43,840 (42.59%) |
