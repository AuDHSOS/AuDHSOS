...
and the engine does not. At `7407768` that set holds 2,802 variants:
none of them the engine fails, and 2,802 it names as gaps. The engine
passes 24,927 variants the stack path does not. Only the failures are
...
| 1,315 | 85 further reasons, none above 52 variants |
...
| Complete pinned suite on the register engine | full | `7407768` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 61,479 (59.73%) | 19,300 (18.75%) | 22,146 (21.52%) |
...
| Complete pinned suite, including staging and Intl | full | `7407768` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
