...
| `%TypedArray%` and the twelve of table 71 (focused) | focused | `4a15802` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/TypedArray test/built-ins/TypedArrayConstructors --summary` | 2,184 | 4,322 | 1,090 (25.22%) | 1,120 (25.91%) | 2,112 (48.87%) |
...
| Complete pinned suite, including staging and Intl | full | `4a15802` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 35,574 (34.56%) | 30,711 (29.84%) | 36,640 (35.60%) |
| Complete pinned suite on the register engine | full | `4a15802` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 38,693 (37.59%) | 19,764 (19.20%) | 44,468 (43.20%) |
