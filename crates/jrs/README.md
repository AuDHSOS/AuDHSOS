...
and the engine does not. At `a19dfa9` that set holds 2,008 variants:
none of them the engine fails, and 2,008 it names as gaps. The engine
...
| Complete pinned suite on the register engine | full | `a19dfa9` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,541 (60.76%) | 19,333 (18.78%) | 21,051 (20.45%) |
...
| Complete pinned suite, including staging and Intl | full | `a19dfa9` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
