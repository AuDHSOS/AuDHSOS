...
and the engine does not. At `eb0a474` that set holds 2,550 variants:
none of them the engine fails, and 2,550 it names as gaps. The engine
...
| 1,167 | 79 further reasons, none above 52 variants |
...
| 27.2.1.5 with a constructor of the Script (focused) | focused | `eb0a474` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Promise --summary` | 732 | 1,458 | 680 (46.64%) | 176 (12.07%) | 602 (41.29%) |
| The same, on the stack backend (focused) | focused | `eb0a474` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/Promise --summary` | 732 | 1,458 | 846 (58.02%) | 598 (41.01%) | 14 (0.96%) |
...
| Complete pinned suite on the register engine | full | `eb0a474` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 61,919 (60.16%) | 19,359 (18.81%) | 21,647 (21.03%) |
...
| Complete pinned suite, including staging and Intl | full | `eb0a474` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
