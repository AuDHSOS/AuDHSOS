...
and the engine does not. At `8483d76` that set holds 3,370 variants:
23 of them the engine fails, and 3,347 it names as gaps. The engine
...
| Complete pinned suite on the register engine | full | `8483d76` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,458 (57.77%) | 19,505 (18.95%) | 23,962 (23.28%) |
