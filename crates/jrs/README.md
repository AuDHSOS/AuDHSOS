...
and the engine does not. At `10c18a2` that set holds 2,236 variants:
none of them the engine fails, and 2,236 it names as gaps. The engine
...
| 230 | a property that is an accessor |
| 202 | an internal method of a Proxy |
| 116 | `ToString` of an Object |
| 96 | `ToPrimitive` of an Object outside a call |
| 92 | an `exec` of the Script |
| 81 | an eval of a Script the lowering does not take |
| 50 | a switch statement |
| 46 | a frame of a call the lowering does not prepare |
| 40 | a name |
| 973 | 76 further reasons, none above 38 variants |
...
| 22.1.3.19 and 22.2.6.11 with a replace value that is callable (focused) | focused | `c6c2d14` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/RegExp test/built-ins/String --summary` | 3,102 | 6,199 | 3,600 (58.07%) | 86 (1.39%) | 2,513 (40.54%) |
...
| Complete pinned suite on the register engine | full | `10c18a2` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,307 (60.54%) | 19,353 (18.80%) | 21,265 (20.66%) |
...
| Complete pinned suite, including staging and Intl | full | `10c18a2` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
