...
and the engine does not. At `1f98536` that set holds 2,216 variants:
none of them the engine fails, and 2,216 it names as gaps. The engine
...
| 22.2.6.11 with an `exec` of the Script (focused) | focused | `1f98536` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/RegExp test/built-ins/String --summary` | 3,102 | 6,199 | 3,618 (58.36%) | 86 (1.39%) | 2,495 (40.25%) |
...
| Complete pinned suite on the register engine | full | `1f98536` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,327 (60.56%) | 19,353 (18.80%) | 21,245 (20.64%) |
...
| Complete pinned suite, including staging and Intl | full | `1f98536` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
