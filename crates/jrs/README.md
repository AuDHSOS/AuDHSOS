...
and the engine does not. At `eb7bfd8` that set holds 1,811 variants:
none of them the engine fails, and 1,811 it names as gaps. The engine
...
| 228 | a property that is an accessor |
...
| Complete pinned suite on the register engine | full | `eb7bfd8` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,841 (61.06%) | 19,345 (18.80%) | 20,739 (20.15%) |
...
| Complete pinned suite, including staging and Intl | full | `eb7bfd8` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
