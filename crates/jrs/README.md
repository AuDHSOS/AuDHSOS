...
and the engine does not. At `dafb61d` that set holds 3,382 variants:
35 of them the engine fails, and 3,347 it names as gaps. The engine
...
| Complete pinned suite on the register engine | full | `dafb61d` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,446 (57.76%) | 19,519 (18.97%) | 23,960 (23.28%) |
