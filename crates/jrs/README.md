...
and the engine does not. At `e1707c2` that set holds 2,086 variants:
none of them the engine fails, and 2,086 it names as gaps. The engine
passes 25,211 variants the stack path does not. Only the failures are
...
| 40 | a name |
| 38 | a call |
| 871 | 76 further reasons, none above 36 variants |
...
| Complete pinned suite on the register engine | full | `e1707c2` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,479 (60.70%) | 19,351 (18.80%) | 21,095 (20.50%) |
...
| Complete pinned suite, including staging and Intl | full | `e1707c2` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
