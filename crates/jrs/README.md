...
| Complete pinned suite, including staging and Intl | full | `a6c244e` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 35,574 (34.56%) | 30,711 (29.84%) | 36,640 (35.60%) |
| Complete pinned suite on the register engine | full | `a6c244e` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 34,498 (33.52%) | 19,447 (18.90%) | 48,980 (47.59%) |
