...
and the engine does not. At `c07f9e7` that set holds 2,748 variants:
none of them the engine fails, and 2,748 it names as gaps. The engine
...
| Complete pinned suite on the register engine | full | `c07f9e7` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 61,535 (59.79%) | 19,300 (18.75%) | 22,090 (21.46%) |
...
| Complete pinned suite, including staging and Intl | full | `c07f9e7` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
