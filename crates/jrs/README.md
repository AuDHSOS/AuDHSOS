...
| `%Iterator%` (focused) | focused | `69e48f0` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Iterator --summary` | 654 | 1,308 | 102 (7.80%) | 712 (54.43%) | 494 (37.77%) |
...
| Complete pinned suite, including staging and Intl | full | `69e48f0` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 35,574 (34.56%) | 30,711 (29.84%) | 36,640 (35.60%) |
| Complete pinned suite on the register engine | full | `69e48f0` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 40,571 (39.42%) | 19,782 (19.22%) | 42,572 (41.36%) |
