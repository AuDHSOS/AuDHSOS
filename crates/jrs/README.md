...
| `%Date%` (focused) | focused | `eab8154` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Date --summary` | 594 | 1,188 | 516 (43.43%) | 272 (22.90%) | 400 (33.67%) |
...
| Complete pinned suite, including staging and Intl | full | `eab8154` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 35,574 (34.56%) | 30,711 (29.84%) | 36,640 (35.60%) |
| Complete pinned suite on the register engine | full | `eab8154` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 35,656 (34.64%) | 19,583 (19.03%) | 47,686 (46.33%) |
