...
| `%Promise%` (focused) | focused | `deca8e1` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/Promise --summary` | 732 | 1,458 | 846 (58.02%) | 598 (41.01%) | 14 (0.96%) |
| The same, on the register engine (focused) | focused | `deca8e1` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Promise --summary` | 732 | 1,458 | 308 (21.12%) | 164 (11.25%) | 986 (67.63%) |
| Complete pinned suite, including staging and Intl | full | `deca8e1` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 35,574 (34.56%) | 30,711 (29.84%) | 36,640 (35.60%) |
| Complete pinned suite on the register engine | full | `deca8e1` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 30,262 (29.40%) | 19,671 (19.11%) | 52,992 (51.49%) |
