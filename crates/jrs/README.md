...
and the engine does not. At `f96d4df` that set holds 3,009 variants:
none of them the engine fails, and 3,009 it names as gaps. The engine
passes 24,377 variants the stack path does not. Only the failures are
...
| 1,440 | 85 further reasons, none above 52 variants |
...
| Complete pinned suite on the register engine | full | `f96d4df` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 60,722 (59.00%) | 18,630 (18.10%) | 23,573 (22.90%) |
...
| Complete pinned suite, including staging and Intl | full | `f96d4df` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,561 (37.47%) | 25,010 (24.30%) |
