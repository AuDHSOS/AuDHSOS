...
and the engine does not. At `3dd9831` that set holds 3,408 variants:
47 of them the engine fails, and 3,361 it names as gaps. The engine
...
| Complete pinned suite on the register engine | full | `3dd9831` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,420 (57.73%) | 19,531 (18.98%) | 23,974 (23.29%) |
