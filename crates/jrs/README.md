...
and the engine does not. At `1b4f893` that set holds 3,372 variants:
25 of them the engine fails, and 3,347 it names as gaps. The engine
...
| Complete pinned suite on the register engine | full | `1b4f893` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,456 (57.77%) | 19,507 (18.95%) | 23,962 (23.28%) |
