...
and the engine does not. At `61f3615` that set holds 2,430 variants:
none of them the engine fails, and 2,430 it names as gaps. The engine
...
| Complete pinned suite on the register engine | full | `61f3615` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,095 (60.33%) | 19,359 (18.81%) | 21,471 (20.86%) |
...
| Complete pinned suite, including staging and Intl | full | `61f3615` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
