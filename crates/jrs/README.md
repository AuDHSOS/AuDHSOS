...
| The same, on the register engine (focused) | focused | `1702923` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Array/prototype --summary` | 2,811 | 5,583 | 4,712 (84.40%) | 340 (6.09%) | 531 (9.51%) |
...
| Complete pinned suite, including staging and Intl | full | `72df6bb` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 35,574 (34.56%) | 30,711 (29.84%) | 36,640 (35.60%) |
| Complete pinned suite on the register engine | full | `72df6bb` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 31,944 (31.04%) | 19,359 (18.81%) | 51,622 (50.15%) |
