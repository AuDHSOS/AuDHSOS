...
and the engine does not. At `34287fa` that set holds 3,506 variants:
100 of them the engine fails, and 3,406 it names as gaps. Only the 367
...
| Complete pinned suite on the register engine | full | `34287fa` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,239 (57.56%) | 19,649 (19.09%) | 24,037 (23.35%) |
