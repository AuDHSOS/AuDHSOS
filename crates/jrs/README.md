...
| The update operators of 13.4 (focused) | focused | `90f4774` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/language/expressions/postfix-increment test/language/expressions/postfix-decrement test/language/expressions/prefix-increment test/language/expressions/prefix-decrement --summary` | 142 | 246 | 222 (90.24%) | 0 (0.00%) | 24 (9.76%) |
...
| Complete pinned suite, including staging and Intl | full | `90f4774` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 35,574 (34.56%) | 30,711 (29.84%) | 36,640 (35.60%) |
| Complete pinned suite on the register engine | full | `90f4774` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 30,928 (30.05%) | 19,164 (18.62%) | 52,833 (51.33%) |
