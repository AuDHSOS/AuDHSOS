...
and the engine does not. At `83f29cf` that set holds 2,822 variants:
none of them the engine fails, and 2,822 it names as gaps. The engine
passes 24,923 variants the stack path does not. Only the failures are
...
| 308 | a property that is an accessor |
| 194 | an internal method of a Proxy |
...
| 1,339 | 86 further reasons, none above 52 variants |
...
| Complete pinned suite on the register engine | full | `83f29cf` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 61,455 (59.71%) | 19,300 (18.75%) | 22,170 (21.54%) |
...
| Complete pinned suite, including staging and Intl | full | `83f29cf` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
