...
| Clause 24 entire: `%Map%`, `%Set%`, `%WeakMap%` and `%WeakSet%` (focused) | focused | `458d2e5` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Map test/built-ins/Set test/built-ins/WeakMap test/built-ins/WeakSet --summary` | 813 | 1,620 | 1,252 (77.28%) | 75 (4.63%) | 293 (18.09%) |
...
| Complete pinned suite, including staging and Intl | full | `011b62f` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 35,574 (34.56%) | 30,711 (29.84%) | 36,640 (35.60%) |
| Complete pinned suite on the register engine | full | `011b62f` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 34,332 (33.36%) | 19,486 (18.93%) | 49,107 (47.71%) |
