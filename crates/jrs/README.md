...
and the engine does not. At `09e2a85` that set holds 3,273 variants:
none of them the engine fails, and 3,273 it names as gaps. The engine
...
| Complete pinned suite on the register engine | full | `09e2a85` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,563 (57.87%) | 19,478 (18.92%) | 23,884 (23.21%) |
