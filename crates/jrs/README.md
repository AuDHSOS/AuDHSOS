...
and the engine does not. At `171115d` that set holds 2,824 variants:
none of them the engine fails, and 2,824 it names as gaps. The engine
passes 24,905 variants the stack path does not. Only the failures are
...
| 1,341 | 87 further reasons, none above 52 variants |
...
| Complete pinned suite on the register engine | full | `171115d` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 61,435 (59.69%) | 19,302 (18.75%) | 22,188 (21.56%) |
...
| Complete pinned suite, including staging and Intl | full | `171115d` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
