...
and the engine does not. At `a71aa05` that set holds 1,938 variants:
none of them the engine fails, and 1,938 it names as gaps. The engine
passes 25,268 variants the stack path does not. Only the failures are
...
| 803 | 77 further reasons, none above 34 variants |
...
| Complete pinned suite on the register engine | full | `a71aa05` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,684 (60.90%) | 19,333 (18.78%) | 20,908 (20.31%) |
...
| Complete pinned suite, including staging and Intl | full | `a71aa05` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
