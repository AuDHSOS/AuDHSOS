...
| `%Date%` (focused) | focused | `f947e5c` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Date --summary` | 594 | 1,188 | 732 (61.62%) | 104 (8.75%) | 352 (29.63%) |
...
| Complete pinned suite, including staging and Intl | full | `f947e5c` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 35,574 (34.56%) | 30,711 (29.84%) | 36,640 (35.60%) |
| Complete pinned suite on the register engine | full | `f947e5c` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 35,922 (34.90%) | 19,377 (18.83%) | 47,626 (46.27%) |
