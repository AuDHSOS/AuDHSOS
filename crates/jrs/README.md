...
| Complete pinned suite, including staging and Intl | full | `459d78f` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 35,574 (34.56%) | 30,711 (29.84%) | 36,640 (35.60%) |
| Complete pinned suite on the register engine | full | `459d78f` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 23,026 (22.37%) | 18,633 (18.10%) | 61,266 (59.52%) |
...
which is the tree of `459d78f`. `RegExp.prototype[@@split]` landed in `fe5797c`
