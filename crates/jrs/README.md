...
| Complete pinned suite, including staging and Intl | full | `e5402166a49fcab99d5075ef2c076e3a49572d46` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 35,574 (34.56%) | 30,711 (29.84%) | 36,640 (35.60%) |
...
on the new engine, and the methods of %String.prototype% it answers. Each produces the counts the legacy stack backend produces for the same
