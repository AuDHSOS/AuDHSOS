...
and the engine does not. At `6fdbb2d` that set holds 3,798 variants:
367 of them the engine fails, and 3,431 it names as gaps. Only the 367
...
| Complete pinned suite on the register engine | full | `6fdbb2d` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 58,869 (57.20%) | 20,379 (19.80%) | 23,677 (23.00%) |
