...
| `%Map%` and `%Set%` (focused) | focused | `1d1a48f` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Map test/built-ins/Set --summary` | 587 | 1,169 | 518 (44.31%) | 198 (16.94%) | 453 (38.75%) |
...
| Complete pinned suite, including staging and Intl | full | `1d1a48f` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 35,574 (34.56%) | 30,711 (29.84%) | 36,640 (35.60%) |
| Complete pinned suite on the register engine | full | `1d1a48f` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 33,485 (32.53%) | 19,586 (19.03%) | 49,854 (48.44%) |
