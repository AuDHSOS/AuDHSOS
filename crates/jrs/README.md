...
| `%Map%` and `%Set%` (focused) | focused | `c7a73fe` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Map test/built-ins/Set --summary` | 587 | 1,169 | 766 (65.53%) | 114 (9.75%) | 289 (24.72%) |
| `%WeakMap%` and `%WeakSet%` (focused) | focused | `7dbd658` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/WeakMap test/built-ins/WeakSet --summary` | 226 | 451 | 328 (72.73%) | 20 (4.43%) | 103 (22.84%) |
...
| Complete pinned suite, including staging and Intl | full | `7dbd658` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 35,574 (34.56%) | 30,711 (29.84%) | 36,640 (35.60%) |
| Complete pinned suite on the register engine | full | `7dbd658` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 34,109 (33.14%) | 19,540 (18.98%) | 49,276 (47.88%) |
