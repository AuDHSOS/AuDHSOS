...
and the engine does not. At `a288ec0` that set holds 3,625 variants:
180 of them the engine fails, and 3,445 it names as gaps. Only the 367
...
| Complete pinned suite on the register engine | full | `a288ec0` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,072 (57.39%) | 19,765 (19.20%) | 24,088 (23.40%) |
