...
and the engine does not. At `2dba242` that set holds 2,869 variants:
none of them the engine fails, and 2,869 it names as gaps. The engine
...
| 1,388 | 86 further reasons, none above 52 variants |
...
| Complete pinned suite on the register engine | full | `2dba242` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 61,026 (59.29%) | 19,326 (18.78%) | 22,573 (21.93%) |
...
| Complete pinned suite, including staging and Intl | full | `2dba242` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
