...
| Complete pinned suite, including staging and Intl | full | `4ecac3b` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 35,574 (34.56%) | 30,711 (29.84%) | 36,640 (35.60%) |
| Complete pinned suite on the register engine | full | `4ecac3b` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 31,201 (30.31%) | 19,331 (18.78%) | 52,393 (50.90%) |
| Complete pinned suite on the register engine, before the jump and the CaseBlock (outdated) | full | `3b287c4` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 31,133 (30.25%) | 19,414 (18.86%) | 52,378 (50.89%) |
