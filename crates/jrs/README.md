...
and the engine does not. At `cf63fa6` that set holds 1,602 variants:
none of them the engine fails, and 1,602 it names as gaps. The engine
passes 25,570 variants the stack path does not. Only the failures are
...
| `667c320` | 4,049 | 679 | 3,370 |
| `74d316f` | 3,997 | 617 | 3,380 |
| `d9d9d0f` | 3,947 | 583 | 3,364 |
...
| `47de4b8` | 3,826 | 397 | 3,429 |
| `68b5d76` | 3,820 | 391 | 3,429 |
| `4b23e8a` | 3,810 | 381 | 3,429 |
| `a3cc74f` | 3,806 | 377 | 3,429 |
| `6fdbb2d` | 3,798 | 367 | 3,431 |
| `0d4889b` | 3,782 | 351 | 3,431 |
| `170dd73` | 3,772 | 341 | 3,431 |
| `802cc27` | 3,764 | 333 | 3,431 |
| `8b08474` | 3,758 | 319 | 3,439 |
| `1b57b97` | 3,743 | 304 | 3,439 |
| `a6a62ff` | 3,735 | 296 | 3,439 |
| `ccc12a3` | 3,721 | 282 | 3,439 |
| `5fc5a1e` | 3,717 | 278 | 3,439 |
| `c6f314f` | 3,709 | 270 | 3,439 |
| `f0af054` | 3,709 | 252 | 3,457 |
| `ec77495` | 3,693 | 236 | 3,457 |
| `c1d91a6` | 3,679 | 236 | 3,443 |
| `7c35648` | 3,669 | 226 | 3,443 |
| `ba07b76` | 3,665 | 220 | 3,445 |
| `06d55ce` | 3,653 | 204 | 3,449 |
| `2d5b17a` | 3,639 | 196 | 3,443 |
| `af64fdf` | 3,627 | 182 | 3,445 |
| `a288ec0` | 3,625 | 180 | 3,445 |
| `bb34843` | 3,603 | 158 | 3,445 |
| `7d2d9a8` | 3,564 | 158 | 3,406 |
| `083283e` | 3,558 | 150 | 3,408 |
| `b6dace1` | 3,546 | 138 | 3,408 |
| `0c03da9` | 3,538 | 130 | 3,408 |
| `6117332` | 3,530 | 124 | 3,406 |
| `10e285c` | 3,524 | 118 | 3,406 |
| `b7e2210` | 3,512 | 106 | 3,406 |
| `fd770ae` | 3,508 | 102 | 3,406 |
| `34287fa` | 3,506 | 100 | 3,406 |
| `1233ee3` | 3,505 | 99 | 3,406 |
| `34eb199` | 3,503 | 97 | 3,406 |
| `28b0f75` | 3,501 | 95 | 3,406 |
| `99ff4f4` | 3,499 | 93 | 3,406 |
| `e904f7e` | 3,497 | 91 | 3,406 |
| `57e59a3` | 3,495 | 89 | 3,406 |
| `b2def04` | 3,493 | 87 | 3,406 |
| `6c8cd80` | 3,487 | 81 | 3,406 |
| `139d4e3` | 3,485 | 79 | 3,406 |
| `04fb035` | 3,481 | 75 | 3,406 |
| `2bcaa67` | 3,477 | 69 | 3,408 |
| `888356e` | 3,471 | 63 | 3,408 |
| `7d9d40e` | 3,459 | 61 | 3,398 |
| `2b57eb9` | 3,443 | 61 | 3,382 |
| `4680308` | 3,422 | 61 | 3,361 |
| `90cfb9c` | 3,416 | 55 | 3,361 |
| `3dd9831` | 3,408 | 47 | 3,361 |
| `bac237e` | 3,390 | 43 | 3,347 |
| `d3181ac` | 3,386 | 39 | 3,347 |
| `dafb61d` | 3,382 | 35 | 3,347 |
| `6d9ce11` | 3,381 | 34 | 3,347 |
| `e3c9126` | 3,379 | 32 | 3,347 |
| `8c88c0b` | 3,378 | 31 | 3,347 |
| `1b4f893` | 3,372 | 25 | 3,347 |
| `8483d76` | 3,370 | 23 | 3,347 |
| `b073e49` | 3,351 | 21 | 3,330 |
| `d32acbf` | 3,347 | 17 | 3,330 |
| `fbccde2` | 3,345 | 15 | 3,330 |
| `91fd2b0` | 3,331 | 11 | 3,320 |
| `061268d` | 3,330 | 10 | 3,320 |
| `5386b6d` | 3,315 | 6 | 3,309 |
| `e7752ab` | 3,311 | 2 | 3,309 |
| `09e2a85` | 3,273 | **0** | 3,273 |
| `5e79e60` | 3,233 | **0** | 3,233 |
| `e608a43` | 3,229 | **0** | 3,229 |
| `75d26e3` | 3,133 | **0** | 3,133 |
| `1033762` | 3,087 | **0** | 3,087 |
| `f96d4df` | 3,009 | **0** | 3,009 |
| `d21598a` | 2,987 | **0** | 2,987 |
| `c880da5` | 2,950 | **0** | 2,950 |
| `585cc99` | 2,905 | **0** | 2,905 |
| `13d2ca8` | 2,869 | **0** | 2,869 |
| `2dba242` | 2,869 | **0** | 2,869 |
| `7c95b6b` | 2,864 | **0** | 2,864 |
| `4fc9d2f` | 2,852 | **0** | 2,852 |
| `33d664f` | 2,836 | **0** | 2,836 |
| `171115d` | 2,824 | **0** | 2,824 |
| `83f29cf` | 2,822 | **0** | 2,822 |
| `7407768` | 2,802 | **0** | 2,802 |
| `096f1f6` | 2,770 | **0** | 2,770 |
| `147c070` | 2,764 | **0** | 2,764 |
| `c07f9e7` | 2,748 | **0** | 2,748 |
| `a9390df` | 2,710 | **0** | 2,710 |
| `a5d339d` | 2,656 | **0** | 2,656 |
| `03d3688` | 2,610 | **0** | 2,610 |
| `aeb3006` | 2,588 | **0** | 2,588 |
| `eb0a474` | 2,550 | **0** | 2,550 |
| `61f3615` | 2,430 | **0** | 2,430 |
| `c6c2d14` | 2,388 | **0** | 2,388 |
| `442fd9d` | 2,324 | **0** | 2,324 |
| `73a90be` | 2,296 | **0** | 2,296 |
| `a47aa3e` | 2,270 | **0** | 2,270 |
| `10c18a2` | 2,236 | **0** | 2,236 |
| `1f98536` | 2,216 | **0** | 2,216 |
| `13e325e` | 2,190 | **0** | 2,190 |
| `73c947b` | 2,150 | **0** | 2,150 |
| `a58ced2` | 2,104 | **0** | 2,104 |
| `e1707c2` | 2,086 | **0** | 2,086 |
| `022d105` | 2,070 | **0** | 2,070 |
| `58ce2b3` | 2,048 | **0** | 2,048 |
| `a19dfa9` | 2,008 | **0** | 2,008 |
| `71aa5c1` | 1,980 | **0** | 1,980 |
| `3fc29d6` | 1,948 | **0** | 1,948 |
| `4a976b8` | 1,940 | **0** | 1,940 |
| `a71aa05` | 1,938 | **0** | 1,938 |
| `9e68fee` | 1,930 | **0** | 1,930 |
| `a43d17f` | 1,920 | **0** | 1,920 |
| `7e9d416` | 1,897 | **0** | 1,897 |
| `c8168d6` | 1,881 | **0** | 1,881 |
| `5eccf65` | 1,863 | **0** | 1,863 |
| `f1b5cf7` | 1,845 | **0** | 1,845 |
| `bc0b1c0` | 1,819 | **0** | 1,819 |
| `eb7bfd8` | 1,811 | **0** | 1,811 |
| `73f10c8` | 1,799 | **0** | 1,799 |
| `0badcc1` | 1,779 | **0** | 1,779 |
| `d5fce96` | 1,771 | **0** | 1,771 |
| `18152de` | 1,769 | **0** | 1,769 |
| `7f68ea8` | 1,757 | **0** | 1,757 |
| `27172bf` | 1,741 | **0** | 1,741 |
| `f6bac5b` | 1,735 | **0** | 1,735 |
| `4039f44` | 1,724 | **0** | 1,724 |
| `59b8616` | 1,718 | **0** | 1,718 |
| `42ddb05` | 1,718 | **0** | 1,718 |
...
| `07c9ec3` | 1,642 | **0** | 1,642 |
| `8d8e63a` | 1,616 | **0** | 1,616 |
...
The latest measurements were run between 2026-09-14 and 2026-09-20
against Test262
revision
...
| `for await` (focused) | focused | `98ff8ed` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/language/statements/for-await-of --summary` | 1,234 | 2,431 | 1,569 (64.54%) | 8 (0.33%) | 854 (35.13%) |
| The same, on the stack backend, which names the statement a gap (focused) | focused | `98ff8ed` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/language/statements/for-await-of --summary` | 1,234 | 2,431 | 102 (4.20%) | 2 (0.08%) | 2,327 (95.72%) |
...
| The same, before the generator method and the field of a derived class (outdated) | focused | `8bd5bc6` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/language/statements/class/elements test/language/expressions/class/elements --summary` | 2,962 | 5,897 | 1,457 (24.71%) | 12 (0.20%) | 4,428 (75.09%) |
| The same, before the private method of 15.7.1 (outdated) | focused | `1fc1014` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/language/statements/class/elements test/language/expressions/class/elements --summary` | 2,962 | 5,897 | 1,240 (21.03%) | 20 (0.34%) | 4,637 (78.63%) |
...
| 23.1.3.4 with a species of the Script (focused) | focused | `10c18a2` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Array --summary` | 3,082 | 6,117 | 5,516 (90.17%) | 46 (0.75%) | 555 (9.07%) |
| The same, before the species of 23.1.3.1 (outdated) | focused | `a47aa3e` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Array --summary` | 3,082 | 6,117 | 5,482 (89.62%) | 46 (0.75%) | 589 (9.63%) |
...
| The `[[OwnPropertyKeys]]` of 10.5.11 out of the handler (focused) | focused | `a737641` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Proxy --summary` | 311 | 607 | 274 (45.14%) | 0 (0.00%) | 333 (54.86%) |
| The same, on the stack backend (focused) | focused | `a737641` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/Proxy --summary` | 311 | 607 | 161 (26.52%) | 359 (59.14%) | 87 (14.33%) |
| The `[[Construct]]` of 10.5.13 out of the handler (outdated) | focused | `42ddb05` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Proxy --summary` | 311 | 607 | 262 (43.16%) | 0 (0.00%) | 345 (56.84%) |
| The same, on the stack backend (focused) | focused | `42ddb05` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/Proxy --summary` | 311 | 607 | 161 (26.52%) | 359 (59.14%) | 87 (14.33%) |
| The `[[Call]]` of 10.5.12 out of the handler (outdated) | focused | `59b8616` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Proxy --summary` | 311 | 607 | 242 (39.87%) | 0 (0.00%) | 365 (60.13%) |
| The same, on the stack backend (focused) | focused | `59b8616` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/Proxy --summary` | 311 | 607 | 161 (26.52%) | 359 (59.14%) | 87 (14.33%) |
| The `[[HasProperty]]` of 10.5.7 and the `[[Delete]]` of 10.5.10 (outdated) | focused | `4039f44` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Proxy --summary` | 311 | 607 | 228 (37.56%) | 0 (0.00%) | 379 (62.44%) |
| The same, on the stack backend (focused) | focused | `4039f44` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/Proxy --summary` | 311 | 607 | 161 (26.52%) | 359 (59.14%) | 87 (14.33%) |
| The `[[GetOwnProperty]]` of 10.5.5 out of the handler (outdated) | focused | `f6bac5b` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Proxy --summary` | 311 | 607 | 190 (31.30%) | 0 (0.00%) | 417 (68.70%) |
...
| The `[[Set]]` of 10.5.9 out of the handler (outdated) | focused | `18152de` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Proxy --summary` | 311 | 607 | 76 (12.52%) | 0 (0.00%) | 531 (87.48%) |
| The same, on the stack backend (focused) | focused | `18152de` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/Proxy --summary` | 311 | 607 | 161 (26.52%) | 359 (59.14%) | 87 (14.33%) |
| The `[[Get]]` of 10.5.8 out of the handler (outdated) | focused | `d5fce96` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Proxy --summary` | 311 | 607 | 66 (10.87%) | 0 (0.00%) | 541 (89.13%) |
| The same, on the stack backend (focused) | focused | `d5fce96` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/Proxy --summary` | 311 | 607 | 161 (26.52%) | 359 (59.14%) | 87 (14.33%) |
| Step 3 of 20.1.2.24 and 20.1.2.5 through the getters (focused) | focused | `0badcc1` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Object --summary` | 3,411 | 6,802 | 6,374 (93.71%) | 2 (0.03%) | 426 (6.26%) |
| The same, on the stack backend (focused) | focused | `0badcc1` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/Object --summary` | 3,411 | 6,802 | 5,922 (87.06%) | 866 (12.73%) | 14 (0.21%) |
| Step 2 of 25.5.2.4 through a getter (focused) | focused | `73f10c8` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/JSON test/staging/sm/JSON --summary` | 204 | 408 | 318 (77.94%) | 4 (0.98%) | 86 (21.08%) |
| The same, on the stack backend (focused) | focused | `73f10c8` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/JSON test/staging/sm/JSON --summary` | 204 | 408 | 350 (85.78%) | 40 (9.80%) | 18 (4.41%) |
| A Promise of a derived class (focused) | focused | `eb7bfd8` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Promise --summary` | 732 | 1,458 | 878 (60.22%) | 176 (12.07%) | 404 (27.71%) |
| The same, on the stack backend (focused) | focused | `eb7bfd8` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/Promise --summary` | 732 | 1,458 | 846 (58.02%) | 598 (41.01%) | 14 (0.96%) |
| The arguments 20.2.1.1 makes a function of (focused) | focused | `bc0b1c0` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Function --summary` | 509 | 893 | 773 (86.56%) | 20 (2.24%) | 100 (11.20%) |
| The same, on the stack backend (focused) | focused | `bc0b1c0` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/Function --summary` | 509 | 893 | 783 (87.68%) | 74 (8.29%) | 36 (4.03%) |
| A read of a binding in its Temporal Dead Zone (focused) | focused | `f1b5cf7` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/language/statements/let test/language/statements/const test/language/block-scope --summary` | 426 | 845 | 742 (87.81%) | 50 (5.92%) | 53 (6.27%) |
| The same, on the stack backend (focused) | focused | `f1b5cf7` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/language/statements/let test/language/statements/const test/language/block-scope --summary` | 426 | 845 | 716 (84.73%) | 78 (9.23%) | 51 (6.04%) |
| The `new.target` an arrow reads (focused) | focused | `5eccf65` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/language/expressions/arrow-function --summary` | 343 | 643 | 531 (82.58%) | 2 (0.31%) | 110 (17.11%) |
| The same, on the stack backend (focused) | focused | `5eccf65` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/language/expressions/arrow-function --summary` | 343 | 643 | 508 (79.00%) | 32 (4.98%) | 103 (16.02%) |
| The `done` and the `value` of 7.4.4 (focused) | focused | `c8168d6` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Array/from test/built-ins/Map test/built-ins/Set test/built-ins/Promise --summary` | 1,366 | 2,717 | 1,915 (70.48%) | 218 (8.02%) | 584 (21.49%) |
| The same, on the stack backend (focused) | focused | `c8168d6` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/Array/from test/built-ins/Map test/built-ins/Set test/built-ins/Promise --summary` | 1,366 | 2,717 | 930 (34.23%) | 1,671 (61.50%) | 116 (4.27%) |
| The `evalScript` of the host object (focused) | focused | `7e9d416` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/language/global-code test/annexB/language/global-code --summary` | 195 | 228 | 67 (29.39%) | 97 (42.54%) | 64 (28.07%) |
| The same, on the stack backend (focused) | focused | `7e9d416` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/language/global-code test/annexB/language/global-code --summary` | 195 | 228 | 99 (43.42%) | 125 (54.82%) | 4 (1.75%) |
| The space of 25.5.2 (focused) | focused | `a43d17f` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/JSON test/staging/sm/JSON --summary` | 204 | 408 | 306 (75.00%) | 4 (0.98%) | 98 (24.02%) |
| The same, on the stack backend (focused) | focused | `a43d17f` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/JSON test/staging/sm/JSON --summary` | 204 | 408 | 350 (85.78%) | 40 (9.80%) | 18 (4.41%) |
| The `this` of a derived constructor, read by an arrow (focused) | focused | `9e68fee` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/language/statements/class test/language/expressions/class --summary` | 8,426 | 16,689 | 13,075 (78.34%) | 108 (0.65%) | 3,506 (21.01%) |
| The same, on the stack backend (focused) | focused | `9e68fee` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/language/statements/class test/language/expressions/class --summary` | 8,426 | 16,689 | 4,766 (28.56%) | 2,898 (17.37%) | 9,025 (54.08%) |
| 28.1.2 with a constructor written in Rust (focused) | focused | `a71aa05` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Reflect test/built-ins/Object --summary` | 3,564 | 7,108 | 6,604 (92.91%) | 2 (0.03%) | 502 (7.06%) |
| The same, on the stack backend (focused) | focused | `a71aa05` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/Reflect test/built-ins/Object --summary` | 3,564 | 7,108 | 6,182 (86.97%) | 912 (12.83%) | 14 (0.20%) |
| A super call of a constructor written in Rust (focused) | focused | `4a976b8` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/language/statements/class/subclass test/language/expressions/class/subclass-builtins test/language/statements/class/subclass-builtins --summary` | 181 | 361 | 238 (65.93%) | 4 (1.11%) | 119 (32.96%) |
| The same, on the stack backend (focused) | focused | `4a976b8` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/language/statements/class/subclass test/language/expressions/class/subclass-builtins test/language/statements/class/subclass-builtins --summary` | 181 | 361 | 240 (66.48%) | 120 (33.24%) | 1 (0.28%) |
| A write through a Super Reference (focused) | focused | `3fc29d6` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/language/expressions/super test/staging/sm/class --summary` | 188 | 371 | 265 (71.43%) | 14 (3.77%) | 92 (24.80%) |
| The same, on the stack backend (focused) | focused | `3fc29d6` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/language/expressions/super test/staging/sm/class --summary` | 188 | 371 | 258 (69.54%) | 61 (16.44%) | 52 (14.02%) |
| The argument 22.1.3 makes a `RegExp` of (focused) | focused | `71aa5c1` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/String/prototype --summary` | 1,073 | 2,144 | 1,930 (90.02%) | 2 (0.09%) | 212 (9.89%) |
| The same, on the stack backend (focused) | focused | `71aa5c1` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/String/prototype --summary` | 1,073 | 2,144 | 1,708 (79.66%) | 382 (17.82%) | 54 (2.52%) |
| A jump out of a try with a Finally Block (focused) | focused | `a19dfa9` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/language/statements/try test/language/statements/for-of test/language/statements/switch --summary` | 1,063 | 2,046 | 1,797 (87.83%) | 38 (1.86%) | 211 (10.31%) |
| The same, on the stack backend (focused) | focused | `a19dfa9` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/language/statements/try test/language/statements/for-of test/language/statements/switch --summary` | 1,063 | 2,046 | 1,617 (79.03%) | 166 (8.11%) | 263 (12.85%) |
| The lexical declarations of a `CaseBlock` (focused) | focused | `58ce2b3` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/language/statements/switch test/language/block-scope test/language/global-code --summary` | 298 | 578 | 473 (81.83%) | 71 (12.28%) | 34 (5.88%) |
| The same, on the stack backend (focused) | focused | `58ce2b3` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/language/statements/switch test/language/block-scope test/language/global-code --summary` | 298 | 578 | 428 (74.05%) | 69 (11.94%) | 81 (14.01%) |
| The pattern and the flags of 22.2.4.1 (focused) | focused | `022d105` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/RegExp --summary` | 1,879 | 3,756 | 1,508 (40.15%) | 70 (1.86%) | 2,178 (57.99%) |
| The same, on the stack backend (focused) | focused | `022d105` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/RegExp --summary` | 1,879 | 3,756 | 1,462 (38.93%) | 96 (2.56%) | 2,198 (58.52%) |
| A clause that converts every argument (focused) | focused | `e1707c2` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Math test/built-ins/String/fromCharCode test/built-ins/String/fromCodePoint --summary` | 355 | 710 | 690 (97.18%) | 0 (0.00%) | 20 (2.82%) |
| The same, on the stack backend (focused) | focused | `e1707c2` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/Math test/built-ins/String/fromCharCode test/built-ins/String/fromCodePoint --summary` | 355 | 710 | 336 (47.32%) | 368 (51.83%) | 6 (0.85%) |
| A computed key of an object pattern (focused) | focused | `a58ced2` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/language/expressions/assignment test/language/statements/for-of --summary` | 1,236 | 2,292 | 1,866 (81.41%) | 25 (1.09%) | 401 (17.50%) |
| The same, on the stack backend (focused) | focused | `a58ced2` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/language/expressions/assignment test/language/statements/for-of --summary` | 1,236 | 2,292 | 1,636 (71.38%) | 149 (6.50%) | 507 (22.12%) |
| 22.2.6.8 and 22.2.6.12 through 22.2.7.1 (focused) | focused | `73c947b` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/RegExp test/built-ins/String --summary` | 3,102 | 6,199 | 3,678 (59.33%) | 86 (1.39%) | 2,435 (39.28%) |
| The same, on the stack backend (focused) | focused | `73c947b` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/RegExp test/built-ins/String --summary` | 3,102 | 6,199 | 3,390 (54.69%) | 544 (8.78%) | 2,265 (36.54%) |
| 22.2.6.11 with the parts step 14 reads (focused, outdated) | focused | `13e325e` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/RegExp test/built-ins/String --summary` | 3,102 | 6,199 | 3,644 (58.78%) | 86 (1.39%) | 2,469 (39.83%) |
| The same, before those reads (outdated) | focused | `1f98536` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/RegExp test/built-ins/String --summary` | 3,102 | 6,199 | 3,618 (58.36%) | 86 (1.39%) | 2,495 (40.25%) |
| The same, on the stack backend (focused) | focused | `1f98536` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/RegExp test/built-ins/String --summary` | 3,102 | 6,199 | 3,390 (54.69%) | 544 (8.78%) | 2,265 (36.54%) |
| 22.1.3.19 and 22.2.6.11 with a replace value that is callable (focused, outdated) | focused | `c6c2d14` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/RegExp test/built-ins/String --summary` | 3,102 | 6,199 | 3,600 (58.07%) | 86 (1.39%) | 2,513 (40.54%) |
| The same, on the stack backend (focused) | focused | `c6c2d14` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/RegExp test/built-ins/String --summary` | 3,102 | 6,199 | 3,390 (54.69%) | 544 (8.78%) | 2,265 (36.54%) |
| The combinators of 27.2.4 on a constructor of the Script (focused) | focused | `61f3615` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Promise --summary` | 732 | 1,458 | 854 (58.57%) | 176 (12.07%) | 428 (29.36%) |
| The same, on the stack backend (focused) | focused | `61f3615` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/Promise --summary` | 732 | 1,458 | 846 (58.02%) | 598 (41.01%) | 14 (0.96%) |
| 27.2.1.5 with a constructor of the Script (focused, outdated) | focused | `eb0a474` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Promise --summary` | 732 | 1,458 | 680 (46.64%) | 176 (12.07%) | 602 (41.29%) |
| The same, on the stack backend (focused, outdated) | focused | `eb0a474` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/Promise --summary` | 732 | 1,458 | 846 (58.02%) | 598 (41.01%) | 14 (0.96%) |
| 13.2.5.5 step 7 and the 10.4.7 it reaches (focused) | focused | `aeb3006` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/language/expressions/object test/built-ins/Object test/built-ins/Reflect --summary` | 4,734 | 9,360 | 8,399 (89.73%) | 38 (0.41%) | 923 (9.86%) |
| The same, on the stack backend (focused) | focused | `aeb3006` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/language/expressions/object test/built-ins/Object test/built-ins/Reflect --summary` | 4,734 | 9,360 | 7,106 (75.92%) | 1,660 (17.74%) | 594 (6.35%) |
...
| Complete pinned suite on the register engine | full | `cf63fa6` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 63,322 (61.52%) | 18,961 (18.42%) | 20,642 (20.06%) |
...
| The same, on the stack backend (focused) | focused | `cf63fa6` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/language/expressions/arrow-function --summary` | 343 | 643 | 508 (79.00%) | 32 (4.98%) | 103 (16.02%) |
| Complete pinned suite on the register engine, before an arrow that reads `super` (outdated) | full | `8d8e63a` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 63,308 (61.51%) | 18,961 (18.42%) | 20,656 (20.07%) |
| A chain of Proxies in the methods of 10.5 (focused) | focused | `8d8e63a` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Proxy --summary` | 311 | 607 | 332 (54.70%) | 0 (0.00%) | 275 (45.30%) |
| The same, on the stack backend (focused) | focused | `8d8e63a` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/Proxy --summary` | 311 | 607 | 161 (26.52%) | 359 (59.14%) | 87 (14.33%) |
| Complete pinned suite on the register engine, before a chain of Proxies (outdated) | full | `07c9ec3` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 63,268 (61.47%) | 18,961 (18.42%) | 20,696 (20.11%) |
| The `[[Set]]` of 28.1.13 out of the handler (focused) | focused | `07c9ec3` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Proxy --summary` | 311 | 607 | 292 (48.11%) | 0 (0.00%) | 315 (51.89%) |
| The same, on the stack backend (focused) | focused | `07c9ec3` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 test/built-ins/Proxy --summary` | 311 | 607 | 161 (26.52%) | 359 (59.14%) | 87 (14.33%) |
| Complete pinned suite on the register engine, before the `[[Set]]` of 28.1.13 (outdated) | full | `9a1f440` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 63,250 (61.45%) | 18,961 (18.42%) | 20,714 (20.13%) |
...
| Complete pinned suite on the register engine, before B.3.4 in the clause of an `if` (outdated) | full | `a737641` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 63,181 (61.39%) | 19,345 (18.80%) | 20,399 (19.82%) |
| Complete pinned suite on the register engine, before the `[[OwnPropertyKeys]]` of 10.5.11 (outdated) | full | `42ddb05` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 63,143 (61.35%) | 19,345 (18.80%) | 20,437 (19.86%) |
| Complete pinned suite on the register engine, before the `[[Construct]]` of 10.5.13 (outdated) | full | `59b8616` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 63,121 (61.33%) | 19,345 (18.80%) | 20,459 (19.88%) |
| Complete pinned suite on the register engine, before the `[[Call]]` of 10.5.12 (outdated) | full | `4039f44` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 63,105 (61.31%) | 19,345 (18.80%) | 20,475 (19.89%) |
| Complete pinned suite on the register engine, before the `[[HasProperty]]` of 10.5.7 (outdated) | full | `f6bac5b` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 63,061 (61.27%) | 19,345 (18.80%) | 20,519 (19.94%) |
...
| Complete pinned suite on the register engine, before the `[[Get]]` of 10.5.8 (outdated) | full | `0badcc1` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,873 (61.09%) | 19,345 (18.80%) | 20,707 (20.12%) |
| Complete pinned suite on the register engine, before step 3 of 20.1.2.24 through the getters (outdated) | full | `73f10c8` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,853 (61.07%) | 19,345 (18.80%) | 20,727 (20.14%) |
| Complete pinned suite on the register engine, before step 2 of 25.5.2.4 through a getter (outdated) | full | `eb7bfd8` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,841 (61.06%) | 19,345 (18.80%) | 20,739 (20.15%) |
| Complete pinned suite on the register engine, before the Promise of a derived class (outdated) | full | `bc0b1c0` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,833 (61.05%) | 19,345 (18.80%) | 20,747 (20.16%) |
| Complete pinned suite on the register engine, before the arguments 20.2.1.1 makes a function of (outdated) | full | `f1b5cf7` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,807 (61.02%) | 19,345 (18.80%) | 20,773 (20.18%) |
| Complete pinned suite on the register engine, before the Temporal Dead Zone read (outdated) | full | `5eccf65` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,789 (61.00%) | 19,345 (18.80%) | 20,791 (20.20%) |
| Complete pinned suite on the register engine, before the `new.target` an arrow reads (outdated) | full | `c8168d6` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,763 (60.98%) | 19,345 (18.80%) | 20,817 (20.22%) |
| Complete pinned suite on the register engine, before the `done` and the `value` of 7.4.4 (outdated) | full | `7e9d416` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,727 (60.94%) | 19,345 (18.80%) | 20,853 (20.26%) |
| Complete pinned suite on the register engine, before the `evalScript` of the host object (outdated) | full | `a43d17f` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,704 (60.92%) | 19,333 (18.78%) | 20,888 (20.29%) |
| Complete pinned suite on the register engine, before the space of 25.5.2 (outdated) | full | `9e68fee` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,694 (60.91%) | 19,333 (18.78%) | 20,898 (20.30%) |
| Complete pinned suite on the register engine, before the `this` of a derived constructor read by an arrow (outdated) | full | `a71aa05` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,684 (60.90%) | 19,333 (18.78%) | 20,908 (20.31%) |
| Complete pinned suite on the register engine, before 28.1.2 with a constructor written in Rust (outdated) | full | `4a976b8` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,672 (60.89%) | 19,333 (18.78%) | 20,920 (20.33%) |
| Complete pinned suite on the register engine, before the super call of a constructor written in Rust (outdated) | full | `3fc29d6` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,608 (60.83%) | 19,333 (18.78%) | 20,984 (20.39%) |
| Complete pinned suite on the register engine, before a write through a Super Reference (outdated) | full | `71aa5c1` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,569 (60.79%) | 19,333 (18.78%) | 21,023 (20.43%) |
| Complete pinned suite on the register engine, before the argument 22.1.3 makes a `RegExp` of (outdated) | full | `a19dfa9` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,541 (60.76%) | 19,333 (18.78%) | 21,051 (20.45%) |
| Complete pinned suite on the register engine, before a jump out of a try with a Finally Block (outdated) | full | `58ce2b3` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,499 (60.72%) | 19,333 (18.78%) | 21,093 (20.49%) |
| Complete pinned suite on the register engine, before the lexical declarations of a `CaseBlock` (outdated) | full | `022d105` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,477 (60.70%) | 19,333 (18.78%) | 21,115 (20.52%) |
| Complete pinned suite on the register engine, before the pattern and the flags of 22.2.4.1 (outdated) | full | `e1707c2` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,479 (60.70%) | 19,351 (18.80%) | 21,095 (20.50%) |
| Complete pinned suite on the register engine, before the clauses that convert every argument (outdated) | full | `a58ced2` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,455 (60.68%) | 19,351 (18.80%) | 21,119 (20.52%) |
| Complete pinned suite on the register engine, before the computed keys of an object pattern (outdated) | full | `73c947b` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,393 (60.62%) | 19,351 (18.80%) | 21,181 (20.58%) |
| Complete pinned suite on the register engine, before 22.2.6.8 and 22.2.6.12 read through 22.2.7.1 (outdated) | full | `13e325e` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,353 (60.58%) | 19,353 (18.80%) | 21,219 (20.62%) |
| Complete pinned suite on the register engine, before the parts step 14 of 22.2.6.11 reads (outdated) | full | `1f98536` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,327 (60.56%) | 19,353 (18.80%) | 21,245 (20.64%) |
| Complete pinned suite on the register engine, before the `exec` of the Script (outdated) | full | `10c18a2` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,307 (60.54%) | 19,353 (18.80%) | 21,265 (20.66%) |
| Complete pinned suite on the register engine, before the species of 23.1.3.1 (outdated) | full | `a47aa3e` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,273 (60.50%) | 19,353 (18.80%) | 21,299 (20.69%) |
| Complete pinned suite on the register engine, before the species of 23.1.3.4 (outdated) | full | `73a90be` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,247 (60.48%) | 19,353 (18.80%) | 21,325 (20.72%) |
| Complete pinned suite on the register engine, before the reviver of 25.5.1 (outdated) | full | `442fd9d` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,213 (60.44%) | 19,353 (18.80%) | 21,359 (20.75%) |
| Complete pinned suite on the register engine, before the replacer of 25.5.2 (outdated) | full | `c6c2d14` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,137 (60.37%) | 19,359 (18.81%) | 21,429 (20.82%) |
| Complete pinned suite on the register engine, before the replace value that is callable (outdated) | full | `61f3615` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,095 (60.33%) | 19,359 (18.81%) | 21,471 (20.86%) |
| Complete pinned suite on the register engine, before the combinator of 27.2.4 on a constructor of the Script (outdated) | full | `eb0a474` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 61,919 (60.16%) | 19,359 (18.81%) | 21,647 (21.03%) |
| Complete pinned suite on the register engine, before the capability of 27.2.1.5 (outdated) | full | `aeb3006` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 61,879 (60.12%) | 19,359 (18.81%) | 21,687 (21.07%) |
| Complete pinned suite on the register engine, before the `__proto__` key of an Object literal (outdated) | full | `03d3688` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 61,841 (60.08%) | 19,300 (18.75%) | 21,784 (21.16%) |
| Complete pinned suite on the register engine, before the spread element of a super call (outdated) | full | `a5d339d` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 61,795 (60.04%) | 19,300 (18.75%) | 21,830 (21.21%) |
| Complete pinned suite on the register engine, before the getter 7.3.25 reads (outdated) | full | `a9390df` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 61,573 (59.82%) | 19,300 (18.75%) | 22,052 (21.43%) |
| Complete pinned suite on the register engine, before the sort with no comparator (outdated) | full | `c07f9e7` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 61,535 (59.79%) | 19,300 (18.75%) | 22,090 (21.46%) |
| Complete pinned suite on the register engine, before the two texts 22.1.3.19 converts (outdated) | full | `147c070` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 61,519 (59.77%) | 19,300 (18.75%) | 22,106 (21.48%) |
...
| Complete pinned suite on the register engine, before the normal form of 22.1.3.15 (outdated) | full | `33d664f` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 61,411 (59.67%) | 19,302 (18.75%) | 22,212 (21.58%) |
| Complete pinned suite on the register engine, before the notations of 21.1.3 (outdated) | full | `4fc9d2f` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 61,285 (59.54%) | 19,326 (18.78%) | 22,314 (21.68%) |
| Complete pinned suite on the register engine, before the case conversions of 22.1.3 (outdated) | full | `7c95b6b` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 61,031 (59.30%) | 19,326 (18.78%) | 22,568 (21.93%) |
| Complete pinned suite on the register engine, before the unmapped arguments object (outdated) | full | `2dba242` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 61,026 (59.29%) | 19,326 (18.78%) | 22,573 (21.93%) |
| Complete pinned suite on the register engine, before the syntax an eval names as a gap (outdated) | full | `13d2ca8` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 61,046 (59.31%) | 19,371 (18.82%) | 22,508 (21.87%) |
| Complete pinned suite on the register engine, before the name 13.5.1.2 deletes (outdated) | full | `585cc99` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 61,010 (59.28%) | 19,369 (18.82%) | 22,546 (21.90%) |
| Complete pinned suite on the register engine, before the Symbol 7.1.4 step 2 refuses (outdated) | full | `c880da5` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 60,803 (59.08%) | 19,369 (18.82%) | 22,753 (22.11%) |
| Complete pinned suite on the register engine, before the binding a `var` head writes (outdated) | full | `d21598a` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 60,754 (59.03%) | 19,334 (18.78%) | 22,837 (22.19%) |
| Complete pinned suite on the register engine, before the environment an iteration makes (outdated) | full | `f96d4df` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 60,722 (59.00%) | 18,630 (18.10%) | 23,573 (22.90%) |
| Complete pinned suite on the register engine, before the iterable a combinator of 27.2.4 walks (outdated) | full | `1033762` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 60,644 (58.92%) | 18,630 (18.10%) | 23,651 (22.98%) |
| Complete pinned suite on the register engine, before the target of a rest element (outdated) | full | `75d26e3` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 60,583 (58.86%) | 18,630 (18.10%) | 23,712 (23.04%) |
| Complete pinned suite on the register engine, before the dead zone of a parameter (outdated) | full | `e608a43` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,607 (57.91%) | 19,478 (18.92%) | 23,840 (23.16%) |
| Complete pinned suite on the register engine, before the String 22.2.6.11 takes (outdated) | full | `5e79e60` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,603 (57.91%) | 19,478 (18.92%) | 23,844 (23.17%) |
| Complete pinned suite on the register engine, before the method 7.3.11 reads (outdated) | full | `09e2a85` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,563 (57.87%) | 19,478 (18.92%) | 23,884 (23.21%) |
| Complete pinned suite on the register engine, before the Proxy of 28.2.1.1 (outdated) | full | `e7752ab` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,519 (57.83%) | 19,486 (18.93%) | 23,920 (23.24%) |
| Complete pinned suite on the register engine, before the environment of the head of 14.7.5.6 (outdated) | full | `5386b6d` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,515 (57.82%) | 19,490 (18.94%) | 23,920 (23.24%) |
| Complete pinned suite on the register engine, before the environment of an iteration (outdated) | full | `061268d` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,500 (57.81%) | 19,494 (18.94%) | 23,931 (23.25%) |
| Complete pinned suite on the register engine, before the callee of 10.4.4 (outdated) | full | `91fd2b0` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,499 (57.81%) | 19,495 (18.94%) | 23,931 (23.25%) |
| Complete pinned suite on the register engine, before the splitter of 22.2.6.14 (outdated) | full | `fbccde2` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,485 (57.79%) | 19,501 (18.95%) | 23,939 (23.26%) |
| Complete pinned suite on the register engine, before the exec of 22.2.7.1 (outdated) | full | `d32acbf` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,483 (57.79%) | 19,503 (18.95%) | 23,939 (23.26%) |
| Complete pinned suite on the register engine, before the reads of 22.2.6.11 (outdated) | full | `b073e49` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,479 (57.79%) | 19,507 (18.95%) | 23,939 (23.26%) |
| Complete pinned suite on the register engine, before the function 20.2.1.1 makes (outdated) | full | `8483d76` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,458 (57.77%) | 19,505 (18.95%) | 23,962 (23.28%) |
| Complete pinned suite on the register engine, before the close of 7.4.11 for a mapper (outdated) | full | `1b4f893` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,456 (57.77%) | 19,507 (18.95%) | 23,962 (23.28%) |
| Complete pinned suite on the register engine, before the setter 7.3.4 calls (outdated) | full | `8c88c0b` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,450 (57.76%) | 19,515 (18.96%) | 23,960 (23.28%) |
| Complete pinned suite on the register engine, before the strictCaller of 19.2.1.1 (outdated) | full | `e3c9126` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,449 (57.76%) | 19,516 (18.96%) | 23,960 (23.28%) |
| Complete pinned suite on the register engine, before the advance of 22.2.7.3 (outdated) | full | `6d9ce11` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,447 (57.76%) | 19,518 (18.96%) | 23,960 (23.28%) |
| Complete pinned suite on the register engine, before the write of 9.1.1.2.5 (outdated) | full | `dafb61d` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,446 (57.76%) | 19,519 (18.97%) | 23,960 (23.28%) |
| Complete pinned suite on the register engine, before the order of the steps of 13.3.7.1 (outdated) | full | `d3181ac` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,442 (57.75%) | 19,523 (18.97%) | 23,960 (23.28%) |
| Complete pinned suite on the register engine, before the name 9.1.1.4.15 refuses (outdated) | full | `bac237e` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,438 (57.75%) | 19,527 (18.97%) | 23,960 (23.28%) |
| Complete pinned suite on the register engine, before the key of 13.2.5.5 (outdated) | full | `3dd9831` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,420 (57.73%) | 19,531 (18.98%) | 23,974 (23.29%) |
| Complete pinned suite on the register engine, before the argument 7.1.1 converted (outdated) | full | `90cfb9c` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,412 (57.72%) | 19,539 (18.98%) | 23,974 (23.29%) |
| Complete pinned suite on the register engine, before the dead zone of the class name (outdated) | full | `4680308` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,406 (57.72%) | 19,545 (18.99%) | 23,974 (23.29%) |
| Complete pinned suite on the register engine, before the write 6.2.6.1 refuses (outdated) | full | `2b57eb9` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,373 (57.69%) | 19,545 (18.99%) | 24,007 (23.32%) |
| Complete pinned suite on the register engine, before the call of a computed method of a primitive (outdated) | full | `7d9d40e` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,353 (57.67%) | 19,539 (18.98%) | 24,033 (23.35%) |
| Complete pinned suite on the register engine, before steps 4 and 5 of 22.1.3.23 (outdated) | full | `888356e` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,341 (57.65%) | 19,541 (18.99%) | 24,043 (23.36%) |
| Complete pinned suite on the register engine, before the dead zone of 9.1.1.1 (outdated) | full | `6c8cd80` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,321 (57.64%) | 19,561 (19.00%) | 24,043 (23.36%) |
| Complete pinned suite on the register engine, before 7.4.10 in the walk of 7.4.2 (outdated) | full | `b2def04` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,307 (57.62%) | 19,575 (19.02%) | 24,043 (23.36%) |
| Complete pinned suite on the register engine, before the depth of 23.1.3.14 (outdated) | full | `e904f7e` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,249 (57.57%) | 19,639 (19.08%) | 24,037 (23.35%) |
| Complete pinned suite on the register engine, before step 3 of 7.4.2 (outdated) | full | `99ff4f4` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,247 (57.56%) | 19,641 (19.08%) | 24,037 (23.35%) |
| Complete pinned suite on the register engine, before the data property of 13.2.5.5 (outdated) | full | `34287fa` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,239 (57.56%) | 19,649 (19.09%) | 24,037 (23.35%) |
| Complete pinned suite on the register engine, before step 5 of 10.2.2 for 28.1.2 (outdated) | full | `b6dace1` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,197 (57.51%) | 19,691 (19.13%) | 24,037 (23.35%) |
| Complete pinned suite on the register engine, before the own indices 20.1.2.24 reads (outdated) | full | `a288ec0` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,072 (57.39%) | 19,765 (19.20%) | 24,088 (23.40%) |
| Complete pinned suite on the register engine, before step 4.d of 10.1.9.1 (outdated) | full | `ec77495` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,000 (57.32%) | 19,826 (19.26%) | 24,099 (23.41%) |
...
| Complete pinned suite, including staging and Intl | full | `3a6e905` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,098 (37.02%) | 25,473 (24.75%) |
| The same, before B.3.4 in the clause of an `if` (outdated) | full | `d5fce96` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `0badcc1` (outdated) | full | `0badcc1` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `73f10c8` (outdated) | full | `73f10c8` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `eb7bfd8` (outdated) | full | `eb7bfd8` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `bc0b1c0` (outdated) | full | `bc0b1c0` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `f1b5cf7` (outdated) | full | `f1b5cf7` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `5eccf65` (outdated) | full | `5eccf65` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `c8168d6` (outdated) | full | `c8168d6` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `7e9d416` (outdated) | full | `7e9d416` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `a43d17f` (outdated) | full | `a43d17f` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `9e68fee` (outdated) | full | `9e68fee` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `a71aa05` (outdated) | full | `a71aa05` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `4a976b8` (outdated) | full | `4a976b8` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `3fc29d6` (outdated) | full | `3fc29d6` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `71aa5c1` (outdated) | full | `71aa5c1` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `a19dfa9` (outdated) | full | `a19dfa9` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `58ce2b3` (outdated) | full | `58ce2b3` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `022d105` (outdated) | full | `022d105` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `e1707c2` (outdated) | full | `e1707c2` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `a58ced2` (outdated) | full | `a58ced2` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `73c947b` (outdated) | full | `73c947b` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `13e325e` (outdated) | full | `13e325e` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `1f98536` (outdated) | full | `1f98536` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `10c18a2` (outdated) | full | `10c18a2` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `a47aa3e` (outdated) | full | `a47aa3e` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `73a90be` (outdated) | full | `73a90be` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `442fd9d` (outdated) | full | `442fd9d` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `c6c2d14` (outdated) | full | `c6c2d14` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `61f3615` (outdated) | full | `61f3615` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `eb0a474` (outdated) | full | `eb0a474` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `aeb3006` (outdated) | full | `aeb3006` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `03d3688` (outdated) | full | `03d3688` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `a5d339d` (outdated) | full | `a5d339d` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `a9390df` (outdated) | full | `a9390df` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `c07f9e7` (outdated) | full | `c07f9e7` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `147c070` (outdated) | full | `147c070` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
...
| The same, unchanged at `33d664f` (outdated) | full | `33d664f` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `4fc9d2f` (outdated) | full | `4fc9d2f` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `7c95b6b` (outdated) | full | `7c95b6b` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `2dba242` (outdated) | full | `2dba242` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `13d2ca8` (outdated) | full | `13d2ca8` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `585cc99` (outdated) | full | `585cc99` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged at `c880da5` (outdated) | full | `c880da5` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
| The same, unchanged in what it passes at `d21598a` (outdated) | full | `d21598a` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,581 (37.49%) | 24,990 (24.28%) |
| The same, unchanged in what it passes at `f96d4df` (outdated) | full | `f96d4df` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,561 (37.47%) | 25,010 (24.30%) |
| The same, unchanged at `7d9d40e` (outdated) | full | `7d9d40e` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,561 (37.47%) | 25,010 (24.30%) |
| The same, unchanged at the commit before (outdated) | full | `888356e` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,561 (37.47%) | 25,010 (24.30%) |
...
`10ecace`; that step gained 22 variants and lost none. The class-element runs
and the full run beside the private method of 15.7.1 were measured at tree
`1801c26bdaf0bd63b1dd52180cee070f2697b4e5`, which is the tree of `8bd5bc6`;
that step gained 1,153 variants and lost 2, which read a Private Name a class
body inside another one names again: four variants of that shape answered
with bytecode the engine refuses at run time, and the lowering names the gap
for all six. The generator runs and the full run beside 27.5 were measured at
tree `a1d646ab03e5e1cb7b76d9d22408ac0d3db02957`, which is the tree of
...
that step gained 3,543 variants and lost none. The class-element runs and the
full run beside the field of a derived class were measured at tree
`dd6540b2b19f6665b82c828995b645c47399a2ca`, which is the tree of `8e2095d`;
that step gained 136 variants and lost none. The class-element runs and the
full run beside the computed name of a field were measured at tree
`d3616c7a73c315519915bbbd9b3e247938ed68fd`, which is the tree of `1d9478d`;
