...
and the engine does not. At `b6dace1` that set holds 3,546 variants:
138 of them the engine fails, and 3,408 it names as gaps. Only the 367
...
| Complete pinned suite on the register engine | full | `b6dace1` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 59,197 (57.51%) | 19,691 (19.13%) | 24,037 (23.35%) |
