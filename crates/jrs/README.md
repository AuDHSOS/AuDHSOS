...
and the engine does not. At `4039f44` that set holds 1,724 variants:
none of them the engine fails, and 1,724 it names as gaps. The engine
passes 25,475 variants the stack path does not. Only the failures are
...
| 139 | an internal method of a Proxy |
...
| The `[[HasProperty]]` of 10.5.7 and the `[[Delete]]` of 10.5.10 (focused) | focused | `4039f44` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 test/built-ins/Proxy --summary` | 311 | 607 | 228 (37.56%) | 0 (0.00%) | 379 (62.44%) |
...
| Complete pinned suite on the register engine | full | `4039f44` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 63,105 (61.31%) | 19,345 (18.80%) | 20,475 (19.89%) |
