...
and the engine does not. At `7e9d416` that set holds 1,897 variants:
none of them the engine fails, and 1,897 it names as gaps. The engine
passes 25,270 variants the stack path does not. Only the failures are
...
| 244 | a property that is an accessor |
...
| Complete pinned suite on the register engine | full | `7e9d416` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,727 (60.94%) | 19,345 (18.80%) | 20,853 (20.26%) |
...
| Complete pinned suite, including staging and Intl | full | `7e9d416` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
