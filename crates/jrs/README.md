...
| Complete pinned suite, including staging and Intl | full | `7d4fe9ec875244e04043c08414f9878469504051` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 35,574 (34.56%) | 30,711 (29.84%) | 36,640 (35.60%) |
...
methods and `join` of %Array.prototype% it answers. Each produces the counts the legacy
...
`da4011ac65a23328693080a67da8efbe902c02f3`, and the join run and the full run
at tree `75bc66931663a104b8f4c973fae1a7878aa53ca2`.
