...
and the engine does not. At `bc0b1c0` that set holds 1,819 variants:
none of them the engine fails, and 1,819 it names as gaps. The engine
...
| 34 | a Promise of a derived class |
| 703 | 75 further reasons, none above 32 variants |
...
| Complete pinned suite on the register engine | full | `bc0b1c0` | `sh tools/xtask.sh jrs --fuel 1000000 --engine --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 62,833 (61.05%) | 19,345 (18.80%) | 20,747 (20.16%) |
...
| Complete pinned suite, including staging and Intl | full | `bc0b1c0` | `sh tools/xtask.sh jrs --fuel 1000000 --test262 docs/test-ext/test262 --all --summary` | 53,582 | 102,925 | 39,354 (38.24%) | 38,582 (37.49%) | 24,989 (24.28%) |
