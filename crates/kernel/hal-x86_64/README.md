...
handlers, the boot information the loader left behind, the window every
physical frame is reachable through, the lookaside buffer and the
page-table root, the debug console over the serial port, and the exit
device the test runner reads. Every
